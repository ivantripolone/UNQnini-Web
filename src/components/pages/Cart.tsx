...
const Cart = () => {
  ...
  const [getLocaliscount, setLocalDiscount] = useState(0)
  ...
  const handleClick = () => { setDiscount(getLocaliscount); setTotal(total); navigate('/purchase') }
  ...
  const totalToPay = (
    <div style={{ padding: '15px' }}>
      <h3>Total: ${total - (total * (getLocaliscount / 100))}</h3>
